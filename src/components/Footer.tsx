        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-3">
          ...
          <div className="flex flex-col items-center lg:items-start space-y-8">
            ...
            <div className="space-y-4 text-center lg:text-left">
              <p className="text-zinc-400 text-lg leading-relaxed max-w-md">
                Azienda di multiservizi a{" "}
                <span className="text-white font-bold">
                  Terracina e Provincia
                </span>
                . Dal giardinaggio professionale all'edilizia di qualità.
              </p>
              ...
              <div className="pt-4 border-t border-white/5 space-y-2 text-zinc-500 text-xs uppercase tracking-widest font-medium">
                <p className="flex items-center justify-center lg:justify-start gap-2">
                  <MapPin className="h-3 w-3 text-primary" /> Via C. Fusco, 4 -
                  04019 Terracina (LT)
                </p>
                <p className="flex items-center justify-center lg:justify-start gap-2">
                  <FileText className="h-3 w-3 text-primary" /> C.F. ZCC MNC
                  72B44 L120G
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center space-y-8">
            <div className="text-center">
              <h3 className="text-3xl font-black uppercase tracking-tighter text-primary">
                Contattaci Subito
              </h3>
              <p className="text-zinc-500 text-sm font-bold uppercase tracking-widest mt-1">
                Sempre operativi 24/7
              </p>
            </div>

            <div className="flex flex-col w-full max-w-xs space-y-5">
              <a
                href="tel:+393404962500"
                className="flex items-center justify-between p-4 bg-white/5 rounded-2xl hover:bg-primary hover:text-black transition-all group border border-white/10"
              >
                <span className="font-black text-lg">MONICA</span>
                <Phone className="h-6 w-6" />
              </a>
              <a
                href="tel:+393333895067"
                className="flex items-center justify-between p-4 bg-white/5 rounded-2xl hover:bg-primary hover:text-black transition-all group border border-white/10"
              >
              ...
              <div className="flex items-center gap-3 justify-center text-zinc-400 pt-2 text-sm">
                ...
                <span className="hover:text-white transition-colors underline decoration-primary/30">
                  monicazecchi56@gmail.com
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center lg:items-end space-y-10">
            ...
            <div className="text-center lg:text-right space-y-4">
              {/* Sede Operativa */}
              <div className="flex items-center justify-center lg:justify-end gap-2 text-primary font-bold uppercase text-[10px] sm:text-xs tracking-widest">
                <MapPin className="h-4 w-4 text-accent" />
                <span>Sede Operativa: Terracina (LT)</span>
              </div>

              {/* Info Legali e Credit */}
              <div className="text-zinc-500 text-[10px] uppercase tracking-[0.2em] leading-loose">
                <p>
                  © {new Date().getFullYear()} Zecchi Multiservizi — Tutti i
                  diritti riservati
                </p>
                ...
                {/* Il tuo Link: M Solutions Web */}
                <div className="mt-4 pt-4 border-t border-white/5 lg:border-none lg:pt-0 lg:mt-2">
                  <span className="opacity-60">Progetto curato da </span>
                  <a
                    href="https://marcocerilli.it"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-accent hover:text-white transition-colors duration-300 font-bold decoration-accent/30 underline-offset-4 hover:underline"
                  >
                    M Solutions Web
                  </a>
                </div>
